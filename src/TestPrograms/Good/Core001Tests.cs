            ...
            return new ProgramNode(new TopFunctionNode(new DummyFilePlace(), LatteType.Int, "main", new BlockNode(
                    ...
                    new ExpressionStatementNode(new DummyFilePlace(),
                        new FunctionCallNode(new DummyFilePlace(), "printInt",
                            new FunctionCallNode(new DummyFilePlace(), "fac", new IntNode(10, new DummyFilePlace())))),
                    new ExpressionStatementNode(new DummyFilePlace(),
                        new FunctionCallNode(new DummyFilePlace(), "printInt",
                            new FunctionCallNode(new DummyFilePlace(), "rfac", new IntNode(10, new DummyFilePlace())))),
                    new ExpressionStatementNode(new DummyFilePlace(),
                        new FunctionCallNode(new DummyFilePlace(), "printInt",
                            new FunctionCallNode(new DummyFilePlace(), "mfac", new IntNode(10, new DummyFilePlace())))),
                    new ExpressionStatementNode(new DummyFilePlace(),
                        new FunctionCallNode(new DummyFilePlace(), "printInt",
                            new FunctionCallNode(new DummyFilePlace(), "ifac", new IntNode(10, new DummyFilePlace())))),
                ...
                new TopFunctionNode(new DummyFilePlace(), LatteType.Int, "fac", new BlockNode(new DummyFilePlace(),
                        ...
                        new WhileNode(new DummyFilePlace(), new CompareNode(RelOperator.GreaterThan,
                            ...
                            new DummyFilePlace()), new BlockNode(new DummyFilePlace(), new BlockNode(
                            new DummyFilePlace(),
                            new BlockNode(new DummyFilePlace(), new AssignmentNode(new DummyFilePlace(), "r",
                    ...
                    new BlockNode(new DummyFilePlace(),
                        new ReturnNode(new DummyFilePlace(),
                            new FunctionCallNode(new DummyFilePlace(), "ifac2f", new IntNode(1, new DummyFilePlace()),
                                new VariableNode("n", new DummyFilePlace())))),
                    new FunctionArgument(LatteType.Int, "n")),
                new TopFunctionNode(new DummyFilePlace(), LatteType.Int, "ifac2f", new BlockNode(new DummyFilePlace(),
