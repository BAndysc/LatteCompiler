            ...
            return new ProgramNode(new List<IFunctionDefinitionNode>()
                {
                    ...
                    new FunctionDefinitionNode(new DummyFilePlace(), LatteType.Bool, "dontCallMe",
                    ...
                    new FunctionDefinitionNode(new DummyFilePlace(), LatteType.Void, "printBool",
                    ...
                    new FunctionDefinitionNode(new DummyFilePlace(), LatteType.Bool, "implies",
